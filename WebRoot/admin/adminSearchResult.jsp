  ...
  <div class="mainBox">
    ...
    <div class="contentBox">
    	...
    	<div class="rightBox">
          ...
          <table width="502">
            <tr>
              <th width="296">Adminstrator</th>
              <th width="91">&nbsp;</th>
              <th width="99">&nbsp;</th>
            </tr>
            <s:iterator value="lists0" var="admin">
            <tr>
              <td><a href="admin/Admin_viewAdminInfo?id=<s:property value="#admin.idAdmin"/>" class="linkA"><s:property value="#admin.username"/></a></td>
              <td>
                <label>
                	<a href="admin/Admin1adminUpdateInput?id_admin=<s:property value="#admin.idAdmin"/>" class="linkA">Modify</a>
                </label>
              </td>
              <td>
                <label>
                	<a href="admin/Admin1deleteAdmin?id_admin=<s:property value="#admin.idAdmin"/>" class="linkA">Delete</a>
                </label>
              </td>
            </tr>
            </s:iterator>
